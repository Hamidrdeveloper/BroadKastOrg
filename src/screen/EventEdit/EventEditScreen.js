...
export const EventEditScreen = ({navigation}) => {
  ...
  const {friendsActive, addGestesEv, setTypeGestes, setAddGestesEv, friendshipListUser} =
        ...
        <ViewMain>
          ...
          <TitleEventFieldAdd style={{color:colors.text.blueLight}}>start-end</TitleEventFieldAdd>
            ...
            <View style={{width: `100%`, paddingLeft: 15, paddingRight: 15}}>
              <ViewSwitch>
                <TextCenterName  style={{
                      fontFamily: "TRYFinder-Light",
                      fontSize: 15,
                      fontWeight: "bold",
                    }}>REPEAT</TextCenterName>
