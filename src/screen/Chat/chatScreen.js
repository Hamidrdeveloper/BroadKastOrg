...
const ChatScreen = ({navigation}) => {
  ...
  return (
    <>
      <ViewTopRowHeader style={{backgroundColor: '#eee', marginTop: Platform.OS=="ios"?25:0}}>
        ...
        <TextCenterName  style={{
                    ...
                    fontSize: 18,
                    fontWeight: "bold",
                  }}>{groupShowData.name}</TextCenterName>
        <TextCenterName
        ...
        <TouchableOpacity
          ...
          <TextCenterName style={{color:"#000",fontSize:20,fontWeight:"bold"}}>{'...'}</TextCenterName>
        </TouchableOpacity>
      </ViewTopRowHeader>
