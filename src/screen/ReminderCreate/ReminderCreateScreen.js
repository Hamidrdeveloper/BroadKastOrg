...
export const ReminderScreen = ({navigation}) => {
  ...
  const [textTimeFromAmOrPm, setTextTimeFromAmOrPm] = useState(false);
  const [textTimeTo, setTextTimeTo] = useState('');
  const [textTimeToAmOrPm, setTextTimeToAmOrPm] = useState(false);
...
if (form_to === 5) {
  ...
  var AmOrPm = hours >= 12 ? true : false;
  hours = hours % 12 || 12;
    ...
    <ViewMain>
      <ScrollViewCenter>
        <ViewTopRowHeader>
          ...
          <TextCenterName style={{textAlign: 'center', fontFamily: "TRYFinder-Light",
                    fontSize: 18,
                    fontWeight: "bold",}}> Create Reminder</TextCenterName>
          <TouchableOpacity
            onPress={() => {
              reminderAddUser();
            }}>
            <TextCenterName style={{textAlign: 'center', fontFamily: "TRYFinder-Light",
                    fontSize: 16,
                    fontWeight: "bold",}}>Add</TextCenterName>
          </TouchableOpacity>
        </ViewTopRowHeader>
        ...
        {isSwitchOnTime ? (
          <ViewBoxTime>
            <ViewSwitch>
              ...
              >
                 {textTimeFrom!=null?
                <View style={{flexDirection:"row",borderColor:"#4ECDC4",borderRadius:8,borderWidth:1,padding:5,fontFamily:"TRYFinder-Light"}}>
                  <Text style={{fontFamily:"TRYFinder-Light"}}>{textTimeFrom}</Text>
                  <View style={{width:5}}/>
                  <Text style={{backgroundColor:textTimeFromAmOrPm?"#ffff":"#4ECDC4",borderRadius:5,padding:2,fontFamily:"TRYFinder-Light"}}>{"AM"}</Text>
                  <View style={{width:5}}/>
                  <Text style={{backgroundColor:textTimeFromAmOrPm==false?"#ffff":"#4ECDC4",borderRadius:5,padding:2,fontFamily:"TRYFinder-Light"}}>{"PM"}</Text>
                </View>
  :null}
                <View style={{height:5}}/>
                {textTimeTo!=null?
                <View style={{flexDirection:"row",borderColor:"#4ECDC4",borderRadius:8,borderWidth:1,padding:5}}>
                  <Text  style={{fontFamily:"TRYFinder-Light"}}>{textTimeTo}</Text>
                  <View style={{width:5}}/>
                  <Text style={{backgroundColor:textTimeFromAmOrPm?"#ffff":"#4ECDC4",borderRadius:5,padding:2,fontFamily:"TRYFinder-Light"}}>{"AM"}</Text>
                  <View style={{width:5}}/>
                  <Text style={{backgroundColor:textTimeFromAmOrPm==false?"#ffff":"#4ECDC4",borderRadius:5,padding:2,fontFamily:"TRYFinder-Light"}}>{"PM"}</Text>
            ...
            <View style={{alignSelf: 'center', paddingRight: 15}}>
              <TouchableOpacity
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TextCenterName>{repeatText}</TextCenterName>
                  <View style={{width: 10}} />
        ...
        <ViewSwitch>
          <TitleEventFieldAdd>PRIORITY</TitleEventFieldAdd>
          {!isRepeat ? (
            <View style={{alignSelf: 'center', paddingRight: 15}}>
              <TouchableOpacity
                onPress={() => {
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TextCenterName>none</TextCenterName>
                  <View style={{width: 10}} />
                  <Icon name="right" size={15} color="#000" />
                </View>
              </TouchableOpacity>
