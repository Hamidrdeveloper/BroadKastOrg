...
export const HomeScreen = ({navigation}) => {
  ...
  const {conectTo} = useContext(HubConnection);
  const {
    reminderListUser,
    reminderAddUser,
    reminderEditUser,
  ...
  const {user, userProfile, checkUserInvite} = useContext(
      ...
      <ViewMain>
        <ViewHeaderMain>
          <ViewTopRow>
            ...
            <TextCenterName style={{fontWeight: 'bold', fontSize: 22}}>
              Bugle
            </TextCenterName>
            <TouchableOpacity
              onPress={() => {
          ...
          <View style={{width: `100%`, height: 100}}>
            <MaskedViewPlus element={<MaskElement></MaskElement>}>
              <FlatListHorGroup
                data={groupUser}
                horizontal={true}
                keyExtractor={(item, index) => String(index)}
        ...
        <Modal
          ...
          <TouchableOpacity
            ...
            <ViewBackModal>
              <ViewOTPCenter>
                <TextCreate style={{color: '#fff', bottom: 20}}>
                  Create
                </TextCreate>
            ...
            <TouchableOpacity
              ...
              <Animated.View
                ...
                {isShowCalendar ? (
                  <Image
                    resizeMode={'contain'}
                    style={{width: 18, height: 18, top: 5}}
